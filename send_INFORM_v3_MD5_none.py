...
#over IPv4/UDP to a Manager at demo.snmplabs.com:162
#send INFORM notification with TRAP ID 'warmStart' specified as an OID
...
config.addTargetAddr(
    snmpEngine, 'my-nms',
    udp.domainName, ('10.10.10.11', 1602),
    'my-creds',
...
sendRequestHandle = ntfOrg.sendVarBinds(
    ...
    [ ((1,3,6,1,6,3,1,1,5,1), v2c.ObjectIdentifier((1,3,6,1,6,3,1,1,5,1))),
     ...
     ,((1,3,6,1,2,1,1,5,1), v2c.OctetString('China Mobile'))
    ],
    cbFun
)
